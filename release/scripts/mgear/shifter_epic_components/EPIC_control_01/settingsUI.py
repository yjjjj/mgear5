...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.descriptionName_checkBox.setText("Use Self Name as Joint Description Name")
    ...
    def retranslateUi(self, Form):
        ...
        self.descriptionName_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>If checked will use the component name as description name for joints. This is ideal for the default EPIC naming system.<br/>If we are using default mGear\'s naming system, is recommended to uncheck this option to avoid repetition in the names.</p></body></html>", None, -1))
